...
export class ContattoService {
  ...
  private apiUrl: string = environment.apiURL + 'v4/contatto';
  ...
  addContatto(params): Observable<any> {
    this.headers = this.headers.set('Authorization', globals.userid);
  ...
  putContatto(params): Observable<any> {
    this.headers = this.headers.set('Authorization', globals.userid);
  ...
  deleteContatto(params): Observable<any> {
    this.headers = this.headers.set('Authorization', globals.userid);
